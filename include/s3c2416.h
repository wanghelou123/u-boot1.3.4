...
/*s3c2416 的HSMMC寄存器  add by whl 2015-07-31 */
#define rHM_SYSAD       (*(volatile unsigned *)0x4AC00000)  //SDI control register
#define rHM_BLKSIZE     (*(volatile unsigned *)0x4AC00004)  //Host buffer boundary and transfer block size register
#define rHM_BLKCNT      (*(volatile unsigned *)0x4AC00006)  //Block count for current transfer
#define rHM_ARGUMENT    (*(volatile unsigned *)0x4AC00008)  //Command Argument
#define rHM_TRNMOD      (*(volatile unsigned *)0x4AC0000C)  //Transfer Mode setting register
#define rHM_CMDREG      (*(volatile unsigned *)0x4AC0000E)  //Command register
#define rHM_RSPREG0     (*(volatile unsigned *)0x4AC00010)  //Response 0
#define rHM_RSPREG1     (*(volatile unsigned *)0x4AC00014)  //Response 1
#define rHM_RSPREG2     (*(volatile unsigned *)0x4AC00018)  //Response 2
#define rHM_RSPREG3     (*(volatile unsigned *)0x4AC0001C)  //Response 3
#define rHM_BDATA       (*(volatile unsigned *)0x4AC00020)  //Buffer Data register
#define rHM_PRNSTS      (*(volatile unsigned *)0x4AC00024)  //Present state
#define rHM_HOSTCTL     (*(volatile unsigned *)0x4AC00028)  //Host control
#define rHM_PWRCON      (*(volatile unsigned *)0x4AC00029)  //Power control
#define rHM_BLKGAP      (*(volatile unsigned *)0x4AC0002A)  //Block Gap control
#define rHM_WAKCON      (*(volatile unsigned *)0x4AC0002B)  //Wakeup control
#define rHM_CLKCON      (*(volatile unsigned *)0x4AC0002C)  //Clock control
#define rHM_TIMEOUTCON  (*(volatile unsigned *)0x4AC0002E)  //Time out control
#define rHM_SWRST       (*(volatile unsigned *)0x4AC0002F)  //Software reset
#define rHM_NORINTSTS   (*(volatile unsigned *)0x4AC00030)  //Normal interrupt status
#define rHM_ERRINTSTS   (*(volatile unsigned *)0x4AC00032)  //Error interrupt status
#define rHM_NORINTSTSEN (*(volatile unsigned *)0x4AC00034)  //Normal interrupt status enable
#define rHM_ERRINTSTSEN (*(volatile unsigned *)0x4AC00036)  //Error interrupt status enable
#define rHM_NORINTSIGEN (*(volatile unsigned *)0x4AC00038)  //Normal interrupt signal enable
#define rHM_ERRINTSIGEN (*(volatile unsigned *)0x4AC0003A)  //Error interrupt signal enable
#define rHM_ACMD12ERRSTS (*(volatile unsigned *)0x4AC0003C) //Auto CMD12 Error Status
#define rHM_CAPAREG     (*(volatile unsigned *)0x4AC00040)  //Capability
#define rHM_MAXCURR     (*(volatile unsigned *)0x4AC00048)  //Maximum current Capability
#define rHM_CONTROL2    (*(volatile unsigned *)0x4AC00080)  //Control 2
#define rHM_CONTROL3    (*(volatile unsigned *)0x4AC00084)  //Control 3
#define rHM_HCVER       (*(volatile unsigned *)0x4AC000FE)  //Host controller version
