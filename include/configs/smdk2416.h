...
#define CONFIG_CMD_LED	//add by whl 2015-07-17 
...
#define CONFIG_BOOTDELAY	1		//modified by whl 2013-6-27
#define CONFIG_BOOTARGS    	"console=ttySAC0,115200n8 root=ubi0:rootfs rw ubi.mtd=3,2048 rootfstype=ubifs rootwait=1" //modified by whl 2015-07-24 
#define CONFIG_ETHADDR		00:40:5c:26:0a:5b
#define CONFIG_NETMASK          255.255.255.0
#define CONFIG_IPADDR		192.168.0.224
#define CONFIG_SERVERIP		192.168.0.231
...
#define CONFIG_BOOTCOMMAND	"led on; nand read.i c0008000 40000 300000;bootm c0008000"
...
#define CONFIG_BOOTCOMMAND	"run update_system"
#else
...
#if 0
	"bootloader_size=40000\0" 	  /* 256KB */	\
	"kernel_size=3c0000\0"    /* 3MB */		\
	"rootfs_size=35db4c0\0"   /* 53MB*/	\
	"update_bootloader=movi read 3800000# ${bootloader_size} ${loadaddr};sleep 1;nand write ${loadaddr} 0 ${bootloader_size}; led blink\0"	\
	"update_kernel=movi read kernel ${loadaddr};nand write.i ${loadaddr} 40000 ${kernel_size};led blink\0"	\
	"update_rootfs=movi read 3600000# ${rootfs_size} ${loadaddr}; nand write.i ${loadaddr} A00000 ${rootfs_size}; led blink\0"	\
	/*从SD的第3500000 sector 开始读512个字节也就是一个sector*/	 \
	"update_image_size=movi read 3500000# 200  ${loadaddr};updateimagesize;\0" \		
	"update_system= led blink; nand scrub ; led blink;nand erase; led blink;run update_image_size; led blink; run update_bootloader; run update_kernel; run update_rootfs;led blink 10;led on;\0"
#endif

/*add by whl 2015-07-20 */
#define CONFIG_EXTRA_ENV_SETTINGS \
	"loadaddr=c0000000\0" 	  \
	"kernel=zImage\0"	\
	"rootfs=rootfs.img\0"	\
	"tu=tftp c0000000 u-boot.bin ; nand erase 0 40000; nand write.i c0000000 0 ${filesize}\0" 	/*网络更新u-boot.bin*/ \
	"update_bootloader=fatload mmc 0  ${loadaddr} /images/u-boot.bin ; nand write.i ${loadaddr} 0 ${filesize}; led blink\0" \
	"update_kernel=fatload mmc 0  ${loadaddr} /images/Linux/${kernel}; nand write.i ${loadaddr} 40000 ${filesize};led blink\0" \
	"update_rootfs=fatload mmc 0  ${loadaddr} /images/Linux/${rootfs};  nand write.i ${loadaddr} A00000 ${filesize}; led blink\0" \
	"update_system=led blink; nand scrub ; led blink;nand erase; led blink; uin; run update_bootloader; run update_kernel; run update_rootfs;led blink 10;led on;\0"
